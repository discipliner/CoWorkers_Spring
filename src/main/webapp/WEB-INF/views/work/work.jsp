...
<head>
    ...
    <link rel="icon" href="/resources/images/doker.ico">
    <link href="/resources/css/bootstrap.min.css" rel="stylesheet">
    <link href="/resources/css/coWorkers.css" rel="stylesheet">
            ...
            <div class="table-responsive">
                ...
                <table class="table" style="margin-left: auto; margin-right: auto;">
                    ...
                    <c:forEach var="dto" items="${priority}">
                        ...
                        <c:if test="${dto.deleteDate==null and dto.currentProgress!=3 and dto.priority==1}">
                            <tr class="bg-danger">
